...
export class TeamsBot extends TeamsActivityHandler {
  ...
  constructor() {
    ...
    this.onMessage(async (context, next) => {
      ...
      console.log(JSON.stringify(context.activity.attachments[0]));

      // Download inline image to test.jpg in current dir.
      ...
      // Need to use bot ID and password to authenticate
